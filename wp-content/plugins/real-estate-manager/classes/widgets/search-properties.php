...
class REM_Search_Property_Widget extends WP_Widget {
	...
	public function form( $instance ) {
		...
		<p>
			<input
				class="widefat"
				type="checkbox" value="on" disabled>
			<label><?php _e( 'Enable Auto Complete Fields','real-estate-manager' ); ?></label> 
			<br>
			<strong><?php _e( 'Available in Pro Version', 'real-estate-manager' ); ?></strong> <i><?php _e( 'It will auto suggest words in text fields as user type in.', 'real-estate-manager' ); ?></i>
		</p>
		<p>
