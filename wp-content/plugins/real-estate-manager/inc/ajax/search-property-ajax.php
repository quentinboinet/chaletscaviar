<?php
    ...
    <?php else : ?>
        ...
        <div class="alert with-icon alert-info" role="alert">
            ...
            <span style="margin-top: 12px;margin-left: 10px;"><?php echo rem_get_option('no_results_msg', __( 'Sorry! No Properties Found. Try Searching Again.', 'real-estate-manager' )) ?></span>
        </div>
    <?php endif;
?>