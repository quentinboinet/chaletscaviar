    ...
    array(
        ...
        'fields'        => array(
            ...
            array(
                ...
                'help' => __( 'Agent Page Template must be set to From Plugin', 'real-estate-manager' ),
            ),            
            array(
                'type'  => 'text',
    ...
    array(
        ...
        'fields'        => array(
            ...
            array(
                ...
                'help' => __( 'Provide additional panel headings for single property pages and admin settings, each per line', 'real-estate-manager' )
                .' <strong>'.__( 'Available in Pro version', 'real-estate-manager' ).'</strong>',
            ),
        ),
    ...
    array(
        ...
        'fields'        => array(
            ...
            array(
                ...
                'title' => __( 'Details Heading', 'real-estate-manager' ),
                'help' => __( 'Provide heading text for property details on property pages', 'real-estate-manager' ),
            ),
    ...
    array(
        ...
        'fields'        => array(
            ...
            array(
                ...
                'help' => __( 'Choose style for leaflet map. More styles are available in pro version. ', 'real-estate-manager' ).'<a target="_blank" href="https://webcodingplace.com/real-estate-manager-wordpress-plugin/leaflet-map-styles-for-real-estate-manager-wp-plugin/">'.__( 'Preview', 'real-estate-manager' ).'</a>',
            ),            
